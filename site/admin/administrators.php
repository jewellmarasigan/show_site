            ...
            if(mysql_num_rows($getAdministrators)!=0)
            {
                ...
                while($row = mysql_fetch_assoc($getAdministrators))
                {
                    ...
                    <li id="administrator<?php echo $admin_id;?>">
						...
						{
							?>
                            <a href="javascript:deleteAdministrator(<?php echo $admin_id;?>);">Delete</a> - <a href="editadministrator?id=<?php echo $admin_id;?>">Edit</a>
                            <?php
						}
						else
						{
							?>
                            <a href="editadministrator?id=<?php echo $admin_id;?>">Edit</a>
                            <?php
						}
						?>
                    </li>
